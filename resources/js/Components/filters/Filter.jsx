        ...
        <>
            ...
            <aside className={`Menu-Filter ${showFilter && 'hidden'}`}>
                <header>
                    ...
                    <h2 className='text-[#1e1e1e] text-center font-bold text-[22px] uppercase'>Filtro de Búsqueda</h2>
                </header>
                ...
                <form>
                    ...
                    <div className="container-form">
                        <h6 className='text-base font-bold'>Precio</h6>
                        <div>
                            <select name="minPrice" id="minPrice" value={searchParams.get("minPrice") ? `minPrice-${searchParams.get("minPrice")}` : "0"} onChange={handleUrl}>
                                <option value="0" disabled>Precio Mín.</option>
                                <option value="minPrice-all">Todos</option>
                            ...
                            <select name="maxPrice" id="maxPrice" value={searchParams.get("maxPrice") ? `maxPrice-${searchParams.get("maxPrice")}` : "0"} onChange={handleUrl}>
                                <option value="0" disabled>Precio Máx.</option>
                                <option value="maxPrice-all">Todos</option>
                    ...
                    {/* Filtro de Dimensión */}
                    <div className="container-form">
                        <h6 className='text-base font-bold'>Dimensión</h6>
                        <div>
                            <select name="minSize" id="minSize" value={searchParams.get("minSize") ? `minSize-${searchParams.get("minSize")}` : "0"} onChange={handleUrl}>
                                <option value="0" disabled>Tamaño Mín.</option>
                                <option value="minSize-all">Todos</option>
                            ...
                            <select name="maxSize" id="maxSize" value={searchParams.get("maxSize") ? `maxSize-${searchParams.get("maxSize")}` : "0"} onChange={handleUrl}>
                                <option value="0" disabled>Tamaño Máx.</option>
                                <option value="maxSize-all">Todos</option>
